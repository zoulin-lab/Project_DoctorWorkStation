...
namespace Doctor_sWorkStation
{
    public partial class frm_SignUp : Form
    {
        ...
        {
            //MessageBox.Show(this.cbxOffices.SelectedValue.ToString());
            ...
            sqlCommand.CommandText =
                "INSERT tb_Doctor (No,Password,Name,OfficeNo) " +
                "VALUES(@No,HASHBYTES('MD5',@Password),@Name,@OfficeNo);";                           //指定SQL命令的命令文本；命令文本包含参数；
            ...
            sqlCommand.Parameters.AddWithValue("@OfficeNo", this.cbxOffices.SelectedValue);
